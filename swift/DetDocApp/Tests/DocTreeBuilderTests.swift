...
@Test nonisolated func buildNestsFilesUnderDocsRoot() throws {
...
@Test nonisolated func buildIncludesEmptyDirectories() throws {
...
@Test nonisolated func buildSortsCaseInsensitively() throws {
